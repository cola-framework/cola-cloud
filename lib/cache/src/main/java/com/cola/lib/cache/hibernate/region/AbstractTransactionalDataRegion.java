...
import com.cola.lib.cache.hibernate.strategy.ReadWriteAccessStrategy;
...
public class AbstractTransactionalDataRegion extends AbstractRegion implements TransactionalDataRegion {
    ...
    public AbstractTransactionalDataRegion(String regionName, Cache cache, Properties properties, SessionFactoryOptions settings, CacheDataDescription metaData) {
